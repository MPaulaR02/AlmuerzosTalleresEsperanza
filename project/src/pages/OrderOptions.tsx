    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg mb-8">
        <div className="flex items-center space-x-4">
          <img
            src={person.photo}
            alt={person.name}
            className="w-20 h-20 rounded-full object-cover border-4 border-[#41BAAE]"
          />
          <div>
            <h1 className="text-3xl font-bold text-gray-800">{person.name}</h1>
            <p className="text-xl text-gray-600 capitalize">{person.category === 'teacher' ? 'Profesor' : 'Estudiante'}</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <Apple size={32} className="mr-3 text-[#BADA55]" />
            Entrada
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              />
              <div className="text-xl font-bold text-gray-800">Fruta</div>
            </button>
            <button
            ...
            >
              <img
                ...
                className="w-full h-32 object-cover rounded-lg mb-3"
              />
              <div className="text-xl font-bold text-gray-800">Sopa</div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <Droplets size={32} className="mr-3 text-[#41BAAE]" />
            Bebida
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
            ...
            >
              <img
                ...
                className="w-full h-32 object-cover rounded-lg mb-3"
              />
              <div className="text-xl font-bold text-gray-800">Jugo</div>
            </button>
            <button
            ...
            >
              <img
                ...
                className="w-full h-32 object-cover rounded-lg mb-3"
              />
              <div className="text-xl font-bold text-gray-800">Limonada</div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <Coffee size={32} className="mr-3 text-orange-500" />
            Plato Principal
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <img
                ...
                className="w-full h-32 object-cover rounded-lg mb-3"
              />
              <div className="text-xl font-bold text-gray-800">Espaguetis</div>
            </button>
            <button
            ...
            >
              <img
                ...
                className="w-full h-32 object-cover rounded-lg mb-3"
              />
              <div className="text-xl font-bold text-gray-800">Carne</div>
            </button>
            <button
            ...
            >
              <img
                ...
                className="w-full h-32 object-cover rounded-lg mb-3"
              />
              <div className="text-xl font-bold text-gray-800">Pechuga de Pollo</div>
            </button>
          </div>
        </div>
        ...
        {/* Observations */}
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Observaciones</h2>
          <textarea
            value={order.observations}
            onChange={(e) => setOrder({...order, observations: e.target.value})}
            className="w-full p-4 border-2 border-gray-200 rounded-lg text-lg focus:border-[#41BAAE] focus:outline-none"
            rows={3}
        ...
        {/* Payment Method */}
        <div className="bg-white rounded-2xl p-6 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Forma de Pago</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <button
            ...
            >
              <div className="text-xl font-bold text-gray-800">💵 Efectivo</div>
            </button>
            <button
            ...
            >
              <div className="text-xl font-bold text-gray-800">🎫 Voucher</div>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-8">
        <button
          ...
          className="flex items-center justify-center space-x-3 bg-gray-600 text-white px-8 py-4 rounded-xl text-xl font-bold hover:bg-gray-700 transition-colors duration-200"
        >
          <ArrowLeft size={24} />
          <span>Volver</span>
        </button>
        ...
        <button
          ...
          className="flex-1 bg-red-500 text-white px-8 py-4 rounded-xl text-xl font-bold hover:bg-red-600 transition-colors duration-200"
        >
          No Almuerza Hoy
        </button>
        ...
        <button
          onClick={handleSave}
          className="flex-1 flex items-center justify-center space-x-3 bg-gradient-to-r from-[#41BAAE] to-[#BADA55] text-white px-8 py-4 rounded-xl text-xl font-bold hover:shadow-lg transition-all duration-200"
        >
          <Save size={24} />
